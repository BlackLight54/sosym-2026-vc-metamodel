...
Emerging digital credential ecosystems allow persons and organizations to receive, hold, and selectively present cryptographically verifiable claims \todo[color=blue!20]{cite: W3C VCDM 2.0}. Such ecosystems are deployed under diverse governance frameworks --- from government-regulated EU Digital Identity Wallets \todo[color=blue!20]{cite: eIDAS 2.0 / EU Digital Identity Wallet} to community-governed decentralized identity systems \todo[color=blue!20]{cite: Hyperledger AnonCreds / Aries}. Designing these ecosystems requires satisfying constraints that span multiple abstraction layers --- from domain-level claim properties through credential schema structure to format-specific privacy capabilities --- yet no integrated formal model captures these cross-layer constraints.
