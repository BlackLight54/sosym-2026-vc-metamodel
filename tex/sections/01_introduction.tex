...
\todo[inline]{cite: existing VC design tools/approaches that are single-layer}
...
\todo[inline]{Finalize contribution list — must align with binding claims #1-#10 in 00_abstract.md}
...
\todo[inline]{Structure paragraph — regenerate with skills/structure_paragraph when sections change.}
