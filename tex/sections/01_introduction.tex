...
\item
  A \textbf{formalization of cross-layer constraints} as graph predicates in the Refinery partial graph modeling framework, supporting consistency checking, error identification, and design space exploration (Section 4.4).
\item
