...
\fxnote{cite: existing VC design tools/approaches that are single-layer}

\fxnote{Verify gap claim — confirm no existing multi-level metamodel for VC ecosystems}
...
\fxnote{Finalize contribution list — must align with binding claims \#1-\#10 in 00_abstract.md}
...
\fxnote{Structure paragraph — regenerate with skills/structure_paragraph when sections change.}
