...
ARF-C4 & Proximity presentation requires mdoc format & ARB\_02 & \texttt{supports\_offline\_verification};
\texttt{fca\_offline\_not\_sdjwt} eliminates SD-JWT-VC \\
...
\subparagraph{Internal validity}\label{internal-validity}
...
\todo[inline]{Remove all FCA (Formal Concept Analysis) references from the paper --- Martin decision to cut FCA framing. Check sections 04, 05, and any propagation rule comments.}

\subparagraph{External validity}\label{external-validity}
...
\subparagraph{Conclusion validity}\label{conclusion-validity}
