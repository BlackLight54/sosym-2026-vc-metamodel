%%
%% main.tex — Root document for MODELS 2026 submission
%% Adapted from tex/template/sample-sigconf-authordraft.tex
%%
...
\title{A Layered Metamodel for Verifiable Credential Ecosystem Design}
...
%% Uncomment each line as the corresponding section file is created.
% \input{tex/sections/01_introduction}
% \input{tex/sections/02_background}
% \input{tex/sections/03_metamodel}
% \input{tex/sections/04_constraints}
