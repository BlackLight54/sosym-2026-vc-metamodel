> Archived 2026-07-13 (todo O-VENUE): superseded MODELS'26 venue record, replaced by the SoSyM record after the venue retarget (D-018); restore by copying the content below back to context/VENUE.md.
...
%% Generated 2026-03-24 from skills/reviewer_archetypes_guide. Re-run after drafting for recalibration. %%
...
%% Style targets, not content references. These are papers from Oszkár's group whose writing style the current paper should emulate. PDFs in `context/references/venue exemplar papers/`. %%
