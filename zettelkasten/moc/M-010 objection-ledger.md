...
| O3 | "Synthetic evaluation, hand-crafted anti-patterns" (Adversarial) | Constraints and anti-patterns trace to cited normative sources: ARF rules ([[S-034 eudiw-arf-2.9.0]]), GDPR + enforcement ([[S-041 gdpr-2016-679]], [[S-042 naih-minimization-fine-2020]]), decree ([[S-043 csok-decree-518-2023]]), W3C bundling case ([[C-035 dependent-claim-bundling]]) | Evaluation §5.1 sourcing sentences |
