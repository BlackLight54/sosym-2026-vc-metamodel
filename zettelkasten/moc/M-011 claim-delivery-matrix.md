...
| [[K-004 automated-consistency-checking]] | delivered | §3.2, §4.4, §5.2 | [[A-005 evaluation-harness]] | F3 scalability (exists) | [[D-008 error-detection-vs-dse-two-modalities]] | O2 | richer instances ([[Q-007 scalability-deeper-hierarchies]]) scheduled in journal scope, [[D-021 q007-structurally-diverse-instances]] |
...
| [[K-006 expressiveness-validation]] | delivered, re-verify open | §5.1.2 | — (constraint table) | F5 expressiveness grid (planned) | [[D-015 expressiveness-strength-first]], [[D-016 dated-snapshot-method-over-catalogue]] | O7, O8 | ARF-C1..C8 vs v2.9.0 (O-EUTHREAT); figure |
