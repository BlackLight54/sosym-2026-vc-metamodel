---
id: S-076
title: Annual Report on Trust Services Security Incidents 2024 (ENISA, agency incident report)
type: source
maturity: seed
...
**ENISA, 2025, ENISA CIRAS annual report series.**
The mandatory aggregation of trust-service security incidents reported by national supervisory bodies under eIDAS, giving the documented failure history (root causes, outages, and human errors) of qualified and non-qualified trust services rather than a framework tutorial. It grounds the governance-conflict class in a primary agency record of how the supervisory regime behind the qualified-provider trusted lists actually fails.

## Verified metadata (2026-07-17)
- Title: Annual Report - Trust Services Security Incidents 2024
- Authors: ENISA (European Union Agency for Cybersecurity)
- Venue: ENISA (EU Agency for Cybersecurity), CIRAS annual report series
- Year: 2025 (published June 2025; the report is named for the 2024 incident-coverage year)
- Locator: https://www.enisa.europa.eu/publications/annual-report-trust-services-security-incidents-2024
- Verification evidence: Confirmed via enisa.europa.eu (published June 2025, CIRAS series); locator resolves to the ENISA publication page.
- Verdict: CONFIRMED
