...
\refi{aligned}, \refi{cross_cred_predicate_gap}, and \refi{common_parent} (defined in supplementary material) feed the anti-pattern analysis (\autoref{sec:evaluation}).
