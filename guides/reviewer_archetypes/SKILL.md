...
**Purpose:** Four reusable reviewer archetypes that `skills/reviewer_personas` instantiates for each paper. The archetypes define *what kind* of reviewer; the personas (in VENUE.md) define *who specifically* for this paper at this venue.
