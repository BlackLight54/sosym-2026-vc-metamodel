...
- `skills/draft_evaluation_design` output (threats identified during evaluation design feed directly here).
...
- During `skills/review_final_review` (as a sub-check).
- After reviewer feedback (new limitations may emerge from reviews).

## Interaction with other skills

- **`skills/draft_evaluation_design`**: Threats identified in evaluation design (step 3) are direct inputs here.
- **`skills/review_claim_evidence_audit`**: If the audit finds overclaims, some may be best resolved by adding limitations rather than strengthening evidence.
- **`skills/setup_reviewer_personas`**: The adversarial reviewer persona drives the priority ranking.
- **`skills/plan_rebuttal`**: Reviewer objections about limitations feed back into this skill for camera-ready revisions.
