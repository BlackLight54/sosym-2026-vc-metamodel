...
**Purpose:** Four reusable reviewer archetypes that `skills/setup_reviewer_personas` instantiates for each paper. The archetypes define *what kind* of reviewer; the personas (in context/VENUE.md) define *who specifically* for this paper at this venue.
...
**Calibration role:** The champion sets the *significance bar*. If no champion would fight for this paper, it will not be accepted regardless of technical quality. The champion test (`skills/review_champion_test`) evaluates whether this reviewer exists for the current paper.
...
- **Related work completeness:** The mathematician will mentally compare against specific papers. Identify these and address them in `skills/research_related_work_positioning`.
...
- **Positioning against competitors:** The adversarial reviewer will advocate for a competing approach. `skills/research_related_work_positioning` must address this head-on.

## How archetypes become personas

The `skills/setup_reviewer_personas` skill instantiates these archetypes for a specific paper and venue:
