...
After generating personas, run `skills/champion_test` to evaluate whether the Champion persona would actually champion this paper. If the champion test fails at this stage, it may be a thesis problem — flag for Martin before proceeding with writing.
...
- Re-run `skills/champion_test` — the champion insight may have shifted.
