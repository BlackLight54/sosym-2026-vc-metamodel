...
For each overclaim: create a todo in `context/todos/` — "Fix overclaim in [location] — either strengthen evidence or weaken claim."
...
- `skills/plan_consolidation_pipeline` — determines task ordering, critical path, and scope cuts.
- `skills/plan_advisor_feedback` — determines whether feedback affects binding claims.
