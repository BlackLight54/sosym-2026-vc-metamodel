...
Run `skills/champion_test`. At the abstract stage, this evaluates whether the thesis has a champion-worthy insight and whether the abstract makes it visible.
